...
def main():
	...
	status = invocador.req.status_code

	if status == 404:
		print("\nInvocador não existe na região informada. Insira outro nome de invocador:\n")
		sleep(2)
		return main()
	elif status == 403:
		print("Chave inválida. Verifique a validade de sua chave.")
	elif status == 200:
		# print(invocador.dados)
